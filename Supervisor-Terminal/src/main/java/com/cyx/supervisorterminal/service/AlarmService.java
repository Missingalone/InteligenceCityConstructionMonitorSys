...
public interface AlarmService {
    /** 根据一条监测数据评估所有匹配规则并创建未重复的告警。 */ void evaluate(BizDevice device, BizDeviceMonitorData data);
    /** 查询当前账号可见项目的告警。 */ List<AlarmRecordVO> list();
    /** 处理指定告警。 */ void handle(Long id, AlarmHandleDTO dto);
}
