...
@Configuration public class EnterpriseSecurityConfig {
    ...
    /** 输出统一错误结果。 */ private void write(jakarta.servlet.http.HttpServletResponse r,ObjectMapper o,int c,String m)throws java.io.IOException{r.setStatus(c);r.setContentType(MediaType.APPLICATION_JSON_VALUE);r.setCharacterEncoding("UTF-8");o.writeValue(r.getWriter(),Result.failure(c,m));}
}
